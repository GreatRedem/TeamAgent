...
const messages: Messages<typeof en> = {
    ...
    'projects.transfer.chooseFile': 'انتخاب فایل',
    'projects.transfer.noFile': 'فایلی انتخاب نشده',
    ...
    'projects.settings.aboutTitle': 'دربارهٔ این پروژه',
    'projects.settings.id': 'شناسه',
    'projects.settings.created': 'ساخته‌شده',
    'projects.settings.changed': 'آخرین تغییر',
