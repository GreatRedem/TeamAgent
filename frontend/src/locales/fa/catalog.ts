const messages: Record<string, string> = {
    ...
    'catalog.capability.panel.tasks.description':
        'به این ایجنت اجازه می‌دهد وظیفه‌های این پروژه، از جمله زنجیره‌ها، را فهرست کند، بسازد، تغییر دهد و حذف کند. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود.',
    'catalog.capability.panel.plugins.label': 'مدیریت پلاگین‌ها',
    'catalog.capability.panel.plugins.description':
        'به این ایجنت اجازه می‌دهد پلاگین‌های این پروژه را فهرست کند، اضافه کند، تغییر دهد و حذف کند. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود.',
    'catalog.capability.panel.agents.label': 'مدیریت ایجنت‌ها',
    'catalog.capability.panel.agents.description':
        'به این ایجنت اجازه می‌دهد ایجنت‌های این پروژه، مدلشان، فایل‌های دستورالعمل و اجازه‌هایشان را فهرست کند، بسازد، تغییر دهد و حذف کند. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند، اما نمی‌توانند اجازه‌ها را تغییر دهند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود. هرگز اجازه‌های خودش را تغییر نمی‌دهد و فقط اجازه‌هایی را می‌دهد که خودش دارد.',
    'catalog.capability.panel.models.label': 'مدیریت مدل‌ها',
    'catalog.capability.panel.models.description':
        'به این ایجنت اجازه می‌دهد مدل‌های این پروژه را فهرست کند، اضافه کند، تغییر دهد، آزمایش کند و حذف کند. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود.',
    'catalog.capability.panel.bots.label': 'مدیریت ربات‌ها',
    'catalog.capability.panel.bots.description':
        'به این ایجنت اجازه می‌دهد ربات‌های تلگرام این پروژه را فهرست کند، اضافه کند، تغییر دهد، آزمایش کند و حذف کند و انتخاب کند کدام ایجنت به هر کدام پاسخ دهد. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود.',
    'catalog.capability.panel.people.label': 'مدیریت افراد و خواندن فعالیت‌ها',
    'catalog.capability.panel.people.description':
        'به این ایجنت اجازه می‌دهد افرادی را که به ربات‌هایتان پیام داده‌اند فهرست کند، کارهایی را که هر کدام اجازه دارند تغییر دهد، و فعالیت‌ها و آمار نمای کلی را بخواند. در گفتگو فقط وقتی کار می‌کند که کسی که درخواست می‌دهد در team.json دست‌کم یک نقش داشته باشد؛ وظیفه‌های زمان‌بندی‌شده هم می‌توانند از آن استفاده کنند، اما نمی‌توانند اجازه‌ها را تغییر دهند. هر تغییر همراه با نام درخواست‌کننده در فعالیت‌ها ثبت می‌شود.',
