...
const tests: Array<[string, () => void]> = [
    ...
    [
        ...
        () => {
                    ...
                    tool_calls: [
                        {
                            ...
                            id: 'call_a',
                            type: 'function',
                            function: { name: 'team_mem', arguments: '' },
                        },
                    ],
                },
                undefined,
            ...
            assembler.chunk(
                { tool_calls: [{ index: 0, function: { name: 'bers', arguments: '{"que' } }] },
                undefined,
                undefined,
            );
            assembler.chunk(
                { tool_calls: [{ index: 0, function: { arguments: 'ry":"al' } }] },
                undefined,
                undefined,
            );
            assembler.chunk(
                { tool_calls: [{ index: 0, function: { arguments: 'ex"}' } }] },
                undefined,
                'tool_calls',
            );
    ...
    [
        ...
        () => {
            ...
            assembler.chunk(
                {
                    tool_calls: [
                        { index: 0, id: 'a', function: { name: 'time_now', arguments: '{}' } },
                    ],
                },
                undefined,
                undefined,
            ...
            assembler.chunk(
                {
                    tool_calls: [
                        { index: 1, id: 'b', function: { name: 'roster_read', arguments: '{}' } },
                    ],
                },
                undefined,
                undefined,
    ...
    [
        ...
        () => {
            ...
            assembler.chunk(
                {
                    toolCalls: [
                        { index: 0, id: 'x', function: { name: 'time_now', arguments: '{}' } },
                    ],
                },
                undefined,
                'tool_calls',
            ...
            assert.deepEqual(
                readToolCalls(assembler.payload()).map((call) => call.name),
                ['time_now'],
            );
        },
    ],
    ...
    [
        ...
        () => {
            ...
            assert.deepEqual((assembler.payload() as { usage?: unknown }).usage, {
                total_tokens: 11,
            });
        },
    ],
    ...
    [
        ...
        () => {
            ...
            const message = (
                assembler.payload() as { choices: Array<{ message: Record<string, unknown> }> }
            ).choices[0].message;
    ...
    [
        ...
        () => {
            ...
            for (const junk of [
                ...
                assert.doesNotThrow(
                    () => assembler.chunk(junk, undefined, undefined),
                    JSON.stringify(junk),
                );
            }
