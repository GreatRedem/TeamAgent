...
export function schemaTelegramWebhook() {
    return {
        response: {
            200: {
                type: 'object',
...
export function schemaConversationList() {
    return {
        response: {
            200: {
                type: 'object',
...
export function schemaTelegramWebhookRegister() {
    return {
        response: {
            200: {
                type: 'object',
...
export function schemaProfileDetails() {
    return {
        response: {
            200: {
                type: 'object',
...
export function schemaPermissionCatalog() {
    return {
        response: {
            200: {
                type: 'object',
...
export function schemaProfilePermissionUpdate() {
    return {
        body: {
            type: 'object',
            required: ['permissions'],
